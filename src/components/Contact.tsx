...
const SocialMediaContact = () => {
  ...
  const renderContactInfo = (contact, index) => (
      ...
      >
        ...
        <p className="text-lg text-white font-medium">{contact.text}</p>
  ...
  const renderSocialLink = (social, index) => (
      ...
      >
        ...
        <p className="text-lg text-white font-medium text-center">{social.text}</p>
  ...
  return (
      <motion.section
          ref={ref}
          className="text-black body-font py-24"
          initial="hidden"
      ...
      >
        <div className="container px-5 mx-auto">
          ...
          {/* Social Links Row */}
          <motion.div
              className={`grid grid-cols-2 sm:grid-cols-2 md:grid-cols-${gridCols} gap-6`}
              variants={containerVariants}
          >
