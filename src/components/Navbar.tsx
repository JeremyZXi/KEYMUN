          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <a href="/" className="flex items-center space-x-2">
                ...
                <img
                    ...
                    alt="ModelUN Logo"
                    className={`h-8 w-8 ${scrolled ? 'opacity-100' : 'opacity-100'}`}
                    style={{
            ...
            <div className="md:hidden">
              <button
                  ...
                  className={`inline-flex items-center justify-center p-2 rounded-md ${scrolled ? 'text-gray-700 hover:text-black hover:bg-gray-200' : 'text-gray-300 hover:text-white hover:bg-gray-700/50'} focus:outline-none`}
              >
        ...
        {isOpen && (
            <div className="md:hidden">
              <div className={`px-2 pt-2 pb-3 space-y-1 sm:px-3 ${scrolled ? 'bg-white' : 'bg-slate-900/80 backdrop-blur-sm'}`}>
                ...
                <a href="/#contact" className={`block px-3 py-2 rounded-md text-base font-medium ${scrolled ? 'text-gray-700' : 'text-gray-300'}`}>Contact</a>
              </div>
            </div>
        )}
      </nav>
